                    ...
                    <div className="w-[30%] m-auto flex flex-col justify-center">
                        ...
                        <div className="flex flex-col">
                            <form action="" className="flex flex-col gap-3 mt-6">
                                ...
                                <button className="bg-[#0CC17A] w-3/4 text-2xl font-semibold py-4 fo rounded-xl m-auto duration-500  hover:bg-green-300 font-sans text-[#fff]" onClick={() => navigate("/salas")}>Entrar</button>
                            </form>
