                ...
                <section className="flex w-11/12 m-auto justify-center items-center h-full">
                    <div className="flex border-dashed flex-col text-center justify-between p-7 h-3/4 border-4 w-1/3 m-auto ">
                        ...
                        <div>
                            ...
                            <button className="text-2xl bg-[#FFB800] p-4 rounded-xl px-20 text-black ">Criar conta</button>
                        </div>
                    </div>
                    <div className="w-[30%] m-auto flex flex-col justify-center">
                        ...
                        <div className="flex flex-col">
                            <form action="" className="flex flex-col gap-2 mt-6">
                                ...
                                <button className="bg-[#0CC17A] w-3/4 text-2xl py-2 fo rounded-xl m-auto">Entrar</button>
                            </form>
